...
<div class="sidebar">
   <a href="dashboard.php" <h2>Flight Books</h2></a>
...
<div class="main">
   ...
   <div class="header">
        ...
        <p>Available Flights Are Here Below:</p>
    </div>
<div class="search-box">
    <form method="POST">
        <input type="text" name="from" placeholder="Enter your Destination!" required>
...
?>
        ...
        <div class="card">
            ...
            <div class="right">
                <?php if ($row['seats_left'] > 0) { ?>
                    <a href="book_ticket.php?route_id=<?php echo $row['route_id']; ?>" class="book-btn">
                        Book Ticket
                    </a>
                <?php } else { ?>
                    <div class="status full">Closed</div>
                <?php } ?>
            </div>
